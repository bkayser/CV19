...
gather(cvdata.us.by_state, key='Measure', value='Recoveries', 'Recovered', 'Est.Recovered', 'Cases') %>%
  filter(State %in% c('Arizona', 'Texas', 'District of Columbia', 'Kentucky', 'Oklahoma', 'Arkansas')) %>%
  ggplot() +
...
gather(cvdata.i18n, key='Measure', value='Recoveries', 'Recovered', 'Est.Recovered', 'Cases') %>%
  filter(Country %in% c('Australia', 'Hubei - China', 'France', 'Italy', 'Spain', 'US', 'Germany', 'Austria', 'Russia', 'Korea, South')) %>%
ggplot() +
