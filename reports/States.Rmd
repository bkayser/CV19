...
```{r echo=F, fig.height=4, fig.width=5}
 state_summary_plot(cvdata.us.by_state, state = 'New York')
 state_summary_plot(cvdata.us.by_state, state = 'Arizona')
 state_summary_plot(cvdata.us.by_state, state = 'California')
 state_summary_plot(cvdata.us.by_state, state = 'Texas')
```
...
```{r echo=F, fig.height=4, fig.width=5}
 state_summary_plot(cvdata.us.by_state, state = 'Oregon')
```
